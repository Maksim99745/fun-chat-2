...
class $ {
    constructor() {
        b(this, "listeners", {}),
            b(this, "on", (t, e) => {
                typeof t == "string" && B(e) && this.subscribe(t, e);
            }),
...
var Q = Object.defineProperty,
    Z = (i, t, e) =>
        t in i
            ...
            : (i[t] = e),
    y = (i, t, e) => (Z(i, typeof t != "symbol" ? t + "" : t, e), e);
class ee {
    constructor(t) {
        y(this, "aboutPageView"),
            y(this, "backButton"),
            y(this, "persistanceService"),
            y(this, "drawAboutView", () => {
...
var oe = Object.defineProperty,
    re = (i, t, e) =>
        t in i
            ...
            : (i[t] = e),
    f = (i, t, e) => (re(i, typeof t != "symbol" ? t + "" : t, e), e);
const k = class {
    constructor(i) {
        f(this, "id"),
            f(this, "from"),
        ...
        h(this, "chatView"),
            ...
            h(this, "addActiveUsers", (e, s) => {
                const n = w(),
                    ...
                    c = [];
                [...l].forEach((u) => {
                    const O = new A(u.login, u.isLogined);
                    this.userModels.set(u.login, O), c.push(O);
                }),
    ...
    constructor(t) {
        super({ tag: "div", className: "chat-page" }),
            ...
            d(this, "removeNewMessagesLine", (e) => {
                ...
                v(n) && this.messangesConteiner.getNode().removeChild(n),
                    s &&
            ...
            d(this, "handleTeextChange", () => {
                r.on("textChanged", (e) => {
                    ...
                    if (s) {
                        ...
                        v(n) && ((n.textContent = e.text), console.log(n));
                    }
                });
            }),
            (this.parent = t),
...
var fe = Object.defineProperty,
    ve = (i, t, e) =>
        t in i
            ...
            : (i[t] = e),
    N = (i, t, e) => (ve(i, typeof t != "symbol" ? t + "" : t, e), e);
class ye extends o {
    constructor(t) {
        super({ tag: "div", className: "error-modal" }),
            N(this, "messagePlace"),
            N(this, "parent"),
            N(this, "setErrorMessage", (s) => {
